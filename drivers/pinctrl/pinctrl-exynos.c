...
static struct samsung_pin_bank exynos5410_pin_banks0[] = {
	...
	EXYNOS_PIN_BANK_EINTG(2, 0x160, "gpm5", 0x2c),
	EXYNOS_PIN_BANK_EINTG(8, 0x180, "gpd1", 0x30),
	EXYNOS_PIN_BANK_EINTG(8, 0x1A0, "gpe0", 0x34),
	EXYNOS_PIN_BANK_EINTG(2, 0x1C0, "gpe1", 0x38),
	EXYNOS_PIN_BANK_EINTG(6, 0x1E0, "gpf0", 0x3c),
	EXYNOS_PIN_BANK_EINTG(8, 0x200, "gpf1", 0x40),
	EXYNOS_PIN_BANK_EINTG(8, 0x220, "gpg0", 0x44),
	EXYNOS_PIN_BANK_EINTG(8, 0x240, "gpg1", 0x48),
	EXYNOS_PIN_BANK_EINTG(2, 0x260, "gpg2", 0x4c),
	EXYNOS_PIN_BANK_EINTG(4, 0x280, "gph0", 0x50),
	EXYNOS_PIN_BANK_EINTG(8, 0x2A0, "gph1", 0x54),
